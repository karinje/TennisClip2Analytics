...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, help='path to output kp file')
    ...
    np.savetxt(args.output_path, np.array(points).astype(int), delimiter=',')
    out_img_path = Path(args.output_path).parent/(str(Path(args.input_path).stem)+'_out.jpg')
    print(f'out_img {out_img_path}')
